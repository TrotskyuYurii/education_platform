...
- Зберігай усі скріншоти та картинки з оригінального тексту! Використовуй тег **Зображення:** [посилання, Base64 код, або текстовий placeholder].
...
**Зображення:** [Якщо у вихідній інструкції є скріншот для цього кроку, встав посилання на нього сюди. Формат: прямий лінк або Base64. Якщо зображення є, але ти не можеш згенерувати посилання, напиши: **Зображення:** [Вставити скріншот: короткий опис того, що зображено]]
