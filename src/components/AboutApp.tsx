          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  В «Адмініструванні» з'явився розділ <strong>«Налаштування»</strong> з глобальними налаштуваннями, що діють одразу для всіх користувачів. У бічному меню адміністрування він разом із «Журналом адміністратора» та «Журналом дій» винесений в окрему групу <strong>«Адміністрування»</strong>, під групами «Матеріали» та «Організація». Групу видно лише тим, кому доступний хоча б один із цих пунктів. Кожне налаштування має перемикач, а зміна зберігається одразу, без кнопки «Зберегти».
                </p>
                <p className="text-sm text-slate-600 leading-relaxed mt-2">
