          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Особистий дашборд співробітника для відстеження успішності: статистика пройдених курсів, графіки середнього балу за підрозділами, кругова діаграма опрацювання регламентів, отримані сертифікати та повна хронологія тестувань. Для користувачів з роллю «Адміністратор» діє розширений функціонал: інтерактивний вибір будь-якого співробітника з бази даних (зі зручним пошуком за email та фільтрами за відділами) для детального перегляду його індивідуального прогресу, балів та сертифікатів.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Доступно лише керівникам. Меню налаштувань поділено на структуровані блоки: «Матеріали» (Інструкції, Курси, Кейси з бейджами кількості, Шаблони для ШІ) та «Організація» (Користувачі та Підрозділи). Функції імпорту та експорту Markdown-файлів (.md) безшовно вбудовані безпосередньо у робочу панель «Інструкції» разом із швидким копіюванням ШІ-промпту для підготовки регламентів. Усі операції видалення (інструкцій, курсів, кейсів та підрозділів) оснащені надійним захистом із підтвердженням «Так / Ні».
                </p>
              </div>
            </div>
