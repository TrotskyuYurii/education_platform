          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Доступно лише керівникам. Функції імпорту підтримують два режими: класичне завантаження .md файлу та <strong>пряме ШІ-завантаження документів (.docx, .pdf, .txt)</strong>. У другому випадку система за допомогою штучного інтелекту Claude сама аналізує вхідний файл, структурує регламент, визначає стоп-списки та генерує тести. Усі операції керування матеріалами й користувачами оснащені надійним захистом.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Повноформатний перенос інструкцій з вихідного файлу в оригінальному вигляді — зі збереженням таблиць, оформлення та ілюстрацій/скріншотів (скріншоти зберігаються окремими файлами у теці інструкції поруч з оригіналом документа). Наприкінці кожної інструкції автоматично виводяться сфокусовані блоки: «📌 Основні висновки», «📋 Ключові поля та обов'язкові реквізити» та «🚫 СТОП-СПИСКИ (Категорично заборонено!)».
                </p>
              </div>
            </div>
