          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Перевірка знань за допомогою інтерактивних тестів. Підтримуються різні рівні складності, відображення робочих ситуацій (контексту) для питань, а також миттєвий зворотний зв'язок з поясненням правильних відповідей.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Особистий дашборд співробітника для відстеження успішності. Містить статистику пройдених курсів, історію результатів тестів та зароблені сертифікати за успішне завершення.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-1">Профіль (Електронний підпис)</h3>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Персональна сторінка користувача, де можна підтвердити ознайомлення з корпоративними регламентами та політиками, що фіксується у системі.
                </p>
              </div>
            </div>
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-1">Адміністрування</h3>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Доступно лише керівникам. Дозволяє масово імпортувати навчальні матеріали у форматі Markdown, керувати базою інструкцій, генерувати PDF-версії документів та відстежувати зміни.
                </p>
              </div>
            </div>
        ...
        <section className="bg-slate-900 rounded-2xl p-6 sm:p-8 text-white shadow-sm relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-slate-300 leading-relaxed mb-4">
              Система працює за моделлю клієнт-серверної архітектури з використанням безпечного JWT (JSON Web Token) механізму авторизації. Усі дані, включаючи інструкції, тестові запитання та прогрес співробітників, надійно зберігаються у хмарній базі даних MongoDB.
            </p>
