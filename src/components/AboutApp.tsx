        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-slate-900 mb-1">Профіль, Аналітика та Сертифікати</h3>
                <p className="text-sm text-slate-600 leading-relaxed">
                  Особистий дашборд співробітника для відстеження успішності: статистика пройдених курсів, графіки середнього балу за підрозділами, кругова діаграма опрацювання регламентів, отримані сертифікати (з можливістю перегляду та експорту в PDF) та повна хронологія тестувань. Для користувачів з роллю «Адміністратор» діє розширений функціонал: інтерактивний вибір будь-якого співробітника з бази даних (зі зручним пошуком за email, фільтрами за відділами та фільтром наявності сертифікатів), а також можливість <strong>анулювати (видаляти) недійсні сертифікати інших користувачів</strong> з миттєвим сповіщенням співробітника.
                </p>
              </div>
            </div>
