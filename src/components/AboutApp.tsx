          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-5 bg-slate-50 rounded-xl border border-slate-100 flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 leading-relaxed">
                  Доступно лише керівникам. Меню налаштувань поділено на структуровані блоки: «Матеріали» (Інструкції, Курси, Кейси з бейджами кількості, Шаблони для ШІ) та «Організація» (Користувачі та Підрозділи). Функції імпорту та експорту Markdown-файлів (.md) безшовно вбудовані безпосередньо у робочу панель «Інструкції» разом із швидким копіюванням ШІ-промпту для підготовки регламентів. Усі дії видалення та редагування містять інлайн-підтвердження без перезавантаження сторінки.
                </p>
              </div>
            </div>
